        ...
        {step === 1 && (
          <form onSubmit={handleRequestOTP} className="space-y-5 animate-in fade-in slide-in-from-bottom-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-zinc-50 border border-zinc-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-black/5 focus:border-black transition-all"
                  placeholder="office@lawsuite.com"
                  required
                />
              </div>
            </div>
            ...
            <button 
              ...
              className="w-full bg-black text-white py-3.5 rounded-xl font-bold text-sm hover:bg-zinc-800 transition-all flex items-center justify-center gap-2 shadow-lg shadow-black/10 disabled:opacity-70"
            >
          ...
          <form onSubmit={handleVerifyOTP} className="space-y-5 animate-in fade-in slide-in-from-right-8">
            <div className="space-y-2">
              ...
              <p className="text-xs text-zinc-500 mt-2 text-center">
                Sent to <span className="font-semibold text-zinc-900">{email}</span>
              </p>
            </div>
            ...
            <button 
              ...
              className="w-full text-xs font-semibold text-zinc-500 hover:text-zinc-900 transition-colors flex items-center justify-center gap-1 mt-4"
            >
